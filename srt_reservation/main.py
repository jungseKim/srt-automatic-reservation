...
class SRT:
    def __init__(self, dpt_stn, arr_stn, dpt_dt, dpt_tm, num_trains_to_check=7, want_reserve=False):
        """
    ...
    def go_search(self):
       ...
       #동승자 입력
        elm_dpt_people = self.driver.find_element(By.NAME, 'psgInfoPerPrnb1')
        print("Ddd",elm_dpt_people)
        self.driver.execute_script("arguments[0].setAttribute('style','display: True;')", elm_dpt_people)
        Select(self.driver.find_element(By.NAME, 'psgInfoPerPrnb1')).select_by_value("2")
